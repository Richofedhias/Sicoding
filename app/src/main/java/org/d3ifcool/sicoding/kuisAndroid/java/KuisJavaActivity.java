...
public class KuisJavaActivity extends AppCompatActivity {
    private KumpulanSoalJava mQuestionLibrary = new KumpulanSoalJava();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_java);
    ...
    private void updateQuestion(){
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(KuisJavaActivity.this, ResultKuisJavaActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            mScore = mScore + 1;
            Toast.makeText(KuisJavaActivity.this, "Benar!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(KuisJavaActivity.this, "Salah!", Toast.LENGTH_SHORT).show();
