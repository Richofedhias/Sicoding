...
import org.d3ifcool.sicoding.kuisDatabase.firebase.ResultKuisFirebaseActivity;

public class KuisJsonActivity extends AppCompatActivity {
    private KumpulanSoalJson mQuestionLibrary = new KumpulanSoalJson();
    ...
    private void updateQuestionJSON(){
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(KuisJsonActivity.this, ResultKuisJsonActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            mScore = mScore + 1;
            Toast.makeText(KuisJsonActivity.this, "Benar!", Toast.LENGTH_SHORT).show();
        }else
