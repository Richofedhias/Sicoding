...
public class ResultKuisMysqlActivity extends AppCompatActivity {
private Button menuawal;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_result_kuis_mysql); TextView txtScore = findViewById(R.id.textScore);
        ...
        menuawal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ResultKuisMysqlActivity.this, BerandaActivity.class));
                finish();
            }
        });
    ...
    public void onClick(View view) {
        Intent intent = new Intent(ResultKuisMysqlActivity.this, KuisMysqlActivity.class);
