...
public class KuisMysqlActivity extends AppCompatActivity {
    private KumpulanSoalMysql mQuestionLibrary = new KumpulanSoalMysql();
    ...
    private void updateQuestionMySQL(){
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(KuisMysqlActivity.this, ResultKuisMysqlActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            mScore = mScore + 1;
            Toast.makeText(KuisMysqlActivity.this, "Benar!", Toast.LENGTH_SHORT).show();
        }else
