...
public class ResultKuisFirebaseActivity extends AppCompatActivity {
    private Button menuawal;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_result_kuis_firebase);
        ...
        menuawal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ResultKuisFirebaseActivity.this, BerandaActivity.class));
                finish();
            }
        });
    ...
    public void onClick(View view) {
        Intent intent = new Intent(ResultKuisFirebaseActivity.this, KuisFirebaseActivity.class);
