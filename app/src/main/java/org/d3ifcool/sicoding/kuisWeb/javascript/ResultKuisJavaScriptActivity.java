...
public class ResultKuisJavaScriptActivity extends AppCompatActivity {
    private Button menuawal;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_result_kuis_java_script);
        ...
        menuawal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ResultKuisJavaScriptActivity.this, BerandaActivity.class));
                finish();
            }
        });
    ...
    public void onClick(View view) {
        Intent intent = new Intent(ResultKuisJavaScriptActivity.this, KuisJavaScriptActivity.class);
