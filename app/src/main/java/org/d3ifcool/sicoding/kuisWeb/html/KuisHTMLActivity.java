...
public class KuisHTMLActivity extends AppCompatActivity {
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(KuisHTMLActivity.this, ResultKuisHTMLActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            mScore = mScore + 1;
            Toast.makeText(KuisHTMLActivity.this, "Benar!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(KuisHTMLActivity.this, "Salah!", Toast.LENGTH_SHORT).show();
