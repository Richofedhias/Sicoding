...
public class ResultKuisHTMLActivity extends AppCompatActivity {
private Button menuawal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuawal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ResultKuisHTMLActivity.this, BerandaActivity.class));
                finish();
            }
        });
    ...
    public void onClick(View view) {
        Intent intent = new Intent(ResultKuisHTMLActivity.this, KuisHTMLActivity.class);
