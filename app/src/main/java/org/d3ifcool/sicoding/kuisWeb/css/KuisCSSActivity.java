...
public class KuisCSSActivity extends AppCompatActivity {
    private KumpulanSoalCSS mQuestionLibrary = new KumpulanSoalCSS();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_css);
    ...
    private void updateQuestion(){
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(KuisCSSActivity.this, ResultKuisCSSActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            mScore = mScore + 1;
            Toast.makeText(KuisCSSActivity.this, "Benar!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(KuisCSSActivity.this, "Salah!", Toast.LENGTH_SHORT).show();
