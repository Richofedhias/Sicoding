...
public class ListMateriPHPActivity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager viewPager;
    ...
    private void viewPager_tabLayout(){
        ...
        viewPager = (ViewPager) findViewById(R.id.viewPager_Materi_php);
        MateriPHPViewPagerAdapter adapter = new MateriPHPViewPagerAdapter(ListMateriPHPActivity.this, getSupportFragmentManager());
        viewPager.setAdapter(adapter);

        // Kodingan Untuk Mengatur Tabs Layout
        tabLayout = (TabLayout) findViewById(R.id.tabs_materi_php);
