...
public class DetailLatihanCSSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_latihan_css);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        judul = findViewById(R.id.tV_judulLatihan_css);
        deskripsi = findViewById(R.id.tV_descLatihan_css);
        hasil = findViewById(R.id.tV_hasilLatihan_css);
